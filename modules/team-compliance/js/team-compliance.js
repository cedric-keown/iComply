...
const representativesData = [
    ...
    { id: 7, name: "Pieter Venter", initials: "PV", email: "pieter.venter@abcfinancial.co.za", fscar: "123462", role: "Financial Advisor", supervisor: "Sarah Naidoo", fpStatus: "compliant", cpdHours: 18, cpdRequired: 18, cpdEthics: 3.5, cpdStatus: "completed", ficaTotal: 40, ficaCurrent: 40, ficaOverdue: 0, ficaStatus: "current", docsTotal: 26, docsCurrent: 26, docsExpired: 0, docsStatus: "current", overallScore: 92, overallStatus: "compliant", lastUpdated: "13/12/2024 09:45", updatedBy: "Self-updated", trend: "→" },
    ...
    { id: 9, name: "David Mthembu", initials: "DM", email: "david.mthembu@abcfinancial.co.za", fscar: "123464", role: "Financial Advisor", supervisor: "Thabo Mokoena", fpStatus: "compliant", cpdHours: 17, cpdRequired: 18, cpdEthics: 3.2, cpdStatus: "in-progress", ficaTotal: 38, ficaCurrent: 38, ficaOverdue: 0, ficaStatus: "current", docsTotal: 25, docsCurrent: 25, docsExpired: 0, docsStatus: "current", overallScore: 83, overallStatus: "compliant", lastUpdated: "13/12/2024 16:10", updatedBy: "Self-updated", trend: "→" },
    ...
    { id: 11, name: "Lerato Dlamini", initials: "LD", email: "lerato.dlamini@abcfinancial.co.za", fscar: "123466", role: "Financial Advisor", supervisor: "Johan Smit", fpStatus: "compliant", cpdHours: 15, cpdRequired: 18, cpdEthics: 3.0, cpdStatus: "in-progress", ficaTotal: 30, ficaCurrent: 30, ficaOverdue: 0, ficaStatus: "current", docsTotal: 22, docsCurrent: 22, docsExpired: 0, docsStatus: "current", overallScore: 80, overallStatus: "compliant", lastUpdated: "11/12/2024 14:45", updatedBy: "Self-updated", trend: "→" },
